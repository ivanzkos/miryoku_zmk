...
U_NP,              U_NP,              U_LT(U_MEDIA, TAB),U_LT(U_NAV, ESC),U_LT(U_MOUSE, RET),U_LT(U_SYM, SPACE),  U_LT(U_NUM, BSPC), U_LT(U_FUN, DEL),  U_NP,              U_NP
...
U_NP,              U_NP,              &kp K_APP,         &kp ESC,           &kp RET,           U_NA,              U_NA,              U_NA,              U_NP,              U_NP
